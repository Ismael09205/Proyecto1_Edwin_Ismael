...
public class PanelCrearUsuarioView {
    ...
    private void aplicarEstilos() {
        ...
        estilizarPanel(PanelDatos, "Datos personales");
        estilizarPanel(PanelRegistrar, "Registrar usuario");

        estilizarLabel(lblNombre);
        estilizarLabel(lblApellido);
        estilizarLabel(lblCedula);
        estilizarLabel(lblProfesion);
        estilizarLabel(lblTelefono);
        estilizarLabel(lblDireccion);
        estilizarLabel(lblNombreUsuario);
        estilizarLabel(lblContrasenia);

        estilizarTextField(txtNombre);
        estilizarTextField(txtApellido);
        estilizarTextField(txtCedula);
        estilizarTextField(txtProfesion);
        estilizarTextField(txtTelefono);
        estilizarTextField(txtDireccion);
        estilizarTextField(txtNombreUsuario);
        estilizarPasswordField(txtContrasenia);

        estilizarRadioButton(rbtnAdministrador);
        estilizarRadioButton(rbtnAnalista);

        estilizarBoton(btnCrear);
    }


    private void estilizarPanel(JPanel panel, String titulo) {
    ...
    private void estilizarPasswordField(JPasswordField txt) {
        estilizarTextField(txt);
    }
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        label1.setText("");
        PanelMain.add(label1, new GridConstraints(1, 2, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
